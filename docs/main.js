...
var DetailsComponent = /** @class */ (function () {
    ...
    DetailsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.data.getUserDetails(this.userId).subscribe(function (data) { return _this.user = data; });
    };
...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.getUserDetails = function (userId) {
...
var SidebarComponent = /** @class */ (function () {
    function SidebarComponent(route) {
        ...
        this.route.events.subscribe(function (_) { _this.currentUrl = _.url; console.log("URLRLLL", _); });
...
module.exports = __webpack_require__(/*! /home/akash/projects/ng6/src/main.ts */"./src/main.ts");
